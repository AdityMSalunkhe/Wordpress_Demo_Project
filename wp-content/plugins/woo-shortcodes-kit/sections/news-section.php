...
<div class="author wshk-tab" id="div-wshk-news">
    ...
    <div class="wshkpagewhitebg">
        ...
        <div class="boxwshknotify newnotify">
            ...
            <h2 class="wshknewsboxtitle"><span class="newsicons dashicons dashicons-bell"></span> <?php esc_html_e( 'WHAT DOES WOO SHORTCODES KIT V.2.0.0 INCLUDE?', 'woo-shortcodes-kit' ); ?>
            </h2>
        
            <p class="wshknewsboxdesc">
                
                <?php esc_html_e( 'Version 2.0.0 includes new changes in the plugin interface, new sections among many other changes.', 'woo-shortcodes-kit' ); ?>
            
            <br>
            
                <?php esc_html_e( 'Also is ready to work with the new WordPress v.5.9 and WooCommerce v.6.1.1', 'woo-shortcodes-kit' ); ?>
            </p>
        
            <br>
        
            <a class="wshknewsboxbutton" href="https://disespubli.com/docs/wshk-v-2-0-0/" target="_blank"><?php esc_html_e( 'Read More', 'woo-shortcodes-kit' ); ?>
            </a>
        ...
        <div class="boxwshknotify newnotify">
            ...
            <h2 class="wshknewsboxtitle"><span class="newsicons dashicons dashicons-bell"></span> <?php esc_html_e( 'NEW UPDATE FOR WSHK PRO - V.1.1.7 ', 'woo-shortcodes-kit' ); ?>
            </h2>
        
            <p class="wshknewsboxdesc">
                
                <?php esc_html_e( 'The version 1.1.7 includes an update on the licensor.', 'woo-shortcodes-kit' ); ?>
            ...
            <a class="wshknewsboxbutton" href="https://disespubli.com/docs/wshk-pro-v-1-1-7/" target="_blank"><?php esc_html_e( 'Read More', 'woo-shortcodes-kit' ); ?>
            </a>
