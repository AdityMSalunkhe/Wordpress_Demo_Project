    ...
    function wshk_newstyle_myaddress() {
        ...
        if (  is_user_logged_in() && ( is_account_page() ) ) {
            ...
            if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { 
                ...
                require ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premmy-address.php';
            } else {
    ...
    function wshk_addresses_get_template( $located, $template_name, $args, $template_path, $default_path ) {
        ...
        if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { 
            ...
            if ( 'myaccount/my-address.php' == $template_name ) {
                $located = ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premmy-address.php';
            }
            
            if ( 'myaccount/form-edit-address.php' == $template_name ) {
                $located = ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premform-edit-address.php';
            }
        }
    ...
    function wshk_newstyle_mypayment() {
        ...
        if (  is_user_logged_in() && ( is_account_page() ) ) {
            ...
            if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { 
                ...
                require ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/prempayment-methods.php';
    ...
    function wshk_payments_get_template( $located, $template_name, $args, $template_path, $default_path ) {
        ...
        if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { 
            ...
            if ( 'myaccount/form-add-payment-method.php' == $template_name ) {
                $located = ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premform-add-payment-method.php';
            }
            
            if ( 'myaccount/payment-methods.php' == $template_name ) {
                $located = ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/prempayment-methods.php';
            }
        }
    ...
    function wshk_newstyle_myeditaccount() {
        ...
        if (  is_user_logged_in() && ( is_account_page() ) ) {
            ...
            if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { 
                ...
                require ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premform-edit-account.php';
    ...
    function wshk_editaccount_get_template( $located, $template_name, $args, $template_path, $default_path ) {
        ...
        if ( in_array( 'custom-redirections-for-wshk/custom-redirections-for-whsk.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
            ...
            if ( 'myaccount/form-edit-account.php' == $template_name ) {
                $located = ABSPATH . '/wp-content/plugins/custom-redirections-for-wshk/mytemplates/premform-edit-account.php';
            }
