...
* URI: http://www.gnu.org/licenses/gpl-3.0.html
  ...
  */
    ...
    <div class="wshkheadertitle" style="width: 100%;background-color: #321A51; border: 1px solid #321A51; border-radius: 13px; padding: 20px;">
        ...
        <h1 class="wshkplutitle"><span style="color: white;">Woo Shortcodes Kit <small>v.2.0.0</small></span></h1>
    ...
    <div id="wshk-tab-menu" style="width:100%;font-weight: 700;font-family: 'Roboto';">
     ...
     <a  id="wshk-news" class="wshk-tab-links"><img src="<?php echo  plugins_url( 'images/notification3.png' , __FILE__ );?>" style="width: 48px; height: 48px;padding-bottom: 15px;" ;><br /><span style="margin-left: -5px;"><?php esc_html_e( 'News', 'woo-shortcodes-kit' ); ?></span></a>
